...
(function (module) {
	...
	function preventIgnoreTags(e) {
		...
		if (ignoreTags[ e.target.tagName ]) { return; }
...
forma = {
  module: $('.forma'),
  rotate: function() {
    var getHidden, getRotate, layoutStates, removeHidden, removeRotate, windowWidth;
    layoutStates = require('../layout/data/layout-states');
    removeRotate = function() {
      if (forma.module.hasClass("forma--rotated")) {
        return forma.module.removeClass("forma--rotated");
      }
    };
    removeHidden = function() {
      if (forma.module.hasClass("forma--hidden")) {
        return forma.module.removeClass("forma--hidden");
      }
    };
    getRotate = function() {
      return forma.module.addClass("forma--rotated");
    };
    getHidden = function() {
      return forma.module.addClass("forma--hidden");
    };
    windowWidth = $(window).width();
    return Object.observe(layoutStates, function(changes) {
      return changes.forEach(function(item, index) {
        switch (item.object.activeIndex) {
          case 0:
            removeHidden();
            return removeRotate();
          case 1:
  ...
  handleClick: function() {
    var triggerStates;
    triggerStates = require('../triggers/data/trigger-states');
    return forma.module.click(function() {
      return triggerStates.neededLayoutClass = 'layout--gallery';
    });
  }
};
...
},{"../layout/data/layout-states":8,"../triggers/data/trigger-states":10,"jquery":2,"object.observe":3}],8:[function(require,module,exports){
layoutStates = {
	activeIndex: 0,
	preventLayoutSwipe: false
}
module.exports = layoutStates
},{}],9:[function(require,module,exports){
var layoutConstruct;

layoutConstruct = function() {
  var $, contactsAnchor, isAnimationPlaying, jQuery, layoutStates, layoutsArrayLength, layoutsContainer, map, module, moduleName, nextTrigger, offMainEvents, scrollPreventer, setBySwipe, setByWheel, setLayout, triggerStates;
  moduleName = 'layout';
  $ = require('jquery');
  ...
  module = $("." + moduleName);
  if (module.length < 1) {
    console.warn('main layouts not detecetd in DOM');
  }
  triggerStates = require('../triggers/data/trigger-states.js');
  layoutStates = require('./data/layout-states.js');
  layoutsArrayLength = module.length;
  module.each(function(i) {
    var layout;
    layout = $(this);
    layout.css({
      'z-index': layoutsArrayLength - i
    });
    if (i === 0) {
      return layout.addClass(moduleName + "--active");
    }
  });
  isAnimationPlaying = false;
  setLayout = function(options) {
    var allPrevlayout, newActiveLayoutIndex, nextFromActiveL, prevActiveLayout;
    if (isAnimationPlaying) {
      return false;
    }
    isAnimationPlaying = true;
    prevActiveLayout = $("." + moduleName + "--active");
    if (options.direction === 'next') {
      nextFromActiveL = prevActiveLayout.next("." + moduleName);
      setTimeout(function() {
        return isAnimationPlaying = false;
      }, 800);
    }
    if (options.direction === 'prev') {
      nextFromActiveL = prevActiveLayout.prev("." + moduleName);
      if (nextFromActiveL.length < 1) {
        isAnimationPlaying = false;
        return false;
      }
      prevActiveLayout.css('transition-delay', '0.8s');
      setTimeout(function() {
        prevActiveLayout.css('transition-delay', '0s');
        prevActiveLayout.removeClass(moduleName + "--hidden");
        return isAnimationPlaying = false;
      }, 800);
    }
    if (options.callLayoutClass) {
      nextFromActiveL = $("." + options.callLayoutClass);
      if (nextFromActiveL.index() < prevActiveLayout.index()) {
        prevActiveLayout.css('transition-delay', '0.8s');
        setTimeout(function() {
          var allNextlayout;
          prevActiveLayout.css('transition-delay', '0s');
          return allNextlayout = nextFromActiveL.nextAll("." + moduleName).removeClass(moduleName + "--hidden");
        }, 800);
      }
      allPrevlayout = nextFromActiveL.prevAll("." + moduleName).addClass(moduleName + "--hidden");
      setTimeout(function() {
        return isAnimationPlaying = false;
      }, 800);
    }
    if (options.direction = void 0 && options.callLayoutClass === void 0) {
      console.warn('direction option into the setLayout method isnt set!');
      return false;
    }
    if (nextFromActiveL.length < 1) {
      return false;
    }
    prevActiveLayout.addClass(moduleName + "--hidden");
    prevActiveLayout.removeClass(moduleName + "--active");
    nextFromActiveL.addClass(moduleName + "--active");
    if (nextFromActiveL.hasClass(moduleName + "--hidden")) {
      nextFromActiveL.removeClass(moduleName + "--hidden");
    }
    newActiveLayoutIndex = void 0;
    module.each(function(i) {
      var classList, thisMod;
      thisMod = $(this);
      if (thisMod.hasClass(moduleName + "--active")) {
        classList = thisMod.attr('class').split(/\s+/);
        $.each(classList, function(index, item) {
          if (item.match(/([\s\S]{1,99})--([\s\S]{1,99})/) && item !== (moduleName + "--active")) {
            return triggerStates.activeLayoutClass = item;
          }
        });
        return newActiveLayoutIndex = i;
      }
    });
    return layoutStates.activeIndex = newActiveLayoutIndex;
  };
  Object.observe(triggerStates, function(changes) {
    return changes.forEach(function(item, index) {
      if (item.object.neededLayoutClass) {
        setLayout({
          callLayoutClass: item.object.neededLayoutClass
        });
      }
      return setTimeout(function() {
        return item.object.neededLayoutClass = '';
      }, 800);
    });
  });
  nextTrigger = module.find("." + moduleName + "__next-trigger");
  nextTrigger.click(function() {
    return setLayout({
      direction: 'next'
    });
  });
  contactsAnchor = module.find("." + moduleName + "__contacts-anchor");
  contactsAnchor.click(function() {
    return setLayout({
      callLayoutClass: $(this).data('layoutcall')
    });
  });
  layoutsContainer = $(".layouts");
  setBySwipe = function(e) {
  ...
  layoutsContainer.on('mousewheel', function(e) {
    e.preventDefault();
    return setByWheel(e);
  });
  layoutsContainer.on('movestart', function(e) {
    e.preventDefault();
    return setBySwipe(e);
  });
  ...
  offMainEvents = function() {
    layoutsContainer.off('movestart');
    return layoutsContainer.off('mousewheel');
  };
  map = module.find("." + moduleName + "__map");
  map.mouseenter(function(e) {
    e.preventDefault();
    map = $(this);
    return map.removeClass(moduleName + "__map--locked");
  });
  map.mouseleave(function(e) {
    e.preventDefault();
    map = $(this);
    return map.addClass(moduleName + "__map--locked");
  });
  scrollPreventer = module.find("." + moduleName + "__j-scroll-xs-preventer");
  scrollPreventer.mouseenter(function(e) {
    e.preventDefault();
    return offMainEvents();
  });
  scrollPreventer.mouseleave(function(e) {
    e.preventDefault();
    layoutsContainer.on('mousewheel', function(e) {
      e.preventDefault();
      return setByWheel(e);
    });
    return layoutsContainer.on('movestart', function(e) {
      e.preventDefault();
      return setBySwipe(e);
    });
  });
  scrollPreventer.on('movestart', function() {
    return offMainEvents();
  });
  return scrollPreventer.on('moveend', function() {
    return layoutsContainer.on('movestart', function(e) {
      e.preventDefault();
      return setBySwipe(e);
    });
...
module.exports = layoutConstruct;

},{"../triggers/data/trigger-states.js":10,"./data/layout-states.js":8,"jquery":2,"jquery.event.move":1}],10:[function(require,module,exports){
triggerStates = {
	neededLayoutClass: '',
	activeLayoutClass: ''
}
module.exports = triggerStates
},{}],11:[function(require,module,exports){
var initTriggers;

initTriggers = function() {
  var $, layoutStates, module, moduleName, triggerStates, triggers;
  $ = require('jquery');
  moduleName = 'triggers';
  module = $("." + moduleName);
  if (module.length > 1) {
  ...
  triggerStates = require('./data/trigger-states.js');
  triggers = module.find("." + moduleName + "__trigger");
  Object.observe(triggerStates, function(changes) {
    return changes.forEach(function(item, index) {
      if (item.object.activeLayoutClass) {
        return triggers.each(function() {
          var trigger;
          trigger = $(this);
          if (trigger.data('trigger') === item.object.activeLayoutClass) {
            trigger.addClass(moduleName + "__trigger--current");
            return trigger.siblings("." + moduleName + "__trigger").removeClass(moduleName + "__trigger--current");
          } else {
            if (trigger.hasClass(moduleName + "__trigger--current")) {
              return trigger.removeClass(moduleName + "__trigger--current");
            }
          }
        });
      }
  ...
  triggers.click(function() {
    var layoutClass, trigger;
    trigger = $(this);
    layoutClass = trigger.data('trigger');
    triggerStates.neededLayoutClass = layoutClass;
    triggers.not(trigger).addClass(moduleName + "__trigger--untouchable");
    return setTimeout(function() {
      return triggers.not(trigger).removeClass(moduleName + "__trigger--untouchable");
    }, 800);
  });
  layoutStates = require('../layout/data/layout-states.js');
  return Object.observe(layoutStates, function(changes) {
    return $(changes).each(function() {
      var activeIndex;
      if (this.object.activeIndex !== void 0) {
        activeIndex = this.object.activeIndex;
        if (activeIndex === 6) {
          return module.addClass(moduleName + "--hidden");
        } else {
          return module.removeClass(moduleName + "--hidden");
        }
      }
    });
  });
...
},{"../layout/data/layout-states.js":8,"./data/trigger-states.js":10,"jquery":2}],12:[function(require,module,exports){
var initXsScrollContent;

initXsScrollContent = function() {
  var $, Simplebar, initScroll, module, moduleName;
  moduleName = 'aside';
  $ = require('jquery');
...
module.exports = initXsScrollContent;

},{"jquery":2,"simplebar":4}],13:[function(require,module,exports){
var checkbox;
...
checkbox = function() {
  ...
  return module.click(function() {
    var thisModule, thisStatus, thisStatusValue;
    thisModule = $(this);
    thisModule.toggleClass(moduleName + "--enabled");
    thisStatus = thisModule.find("." + moduleName + "__status");
    thisStatusValue = thisStatus.val();
    if (thisStatusValue === 'on') {
      return thisStatus.val('off');
    } else {
      return thisStatus.val('on');
    }
  });
};
...
confirmData = function() {
  ...
  return module.click(function() {
    var thisForm, thisMod, thisSubmitter;
    thisMod = $(this);
    thisForm = thisMod.parents('form');
    thisSubmitter = thisForm.find('[type=submit]');
    if (thisMod.hasClass(moduleName + "--confirmed")) {
      thisSubmitter.attr('disabled', '');
      return thisMod.removeClass(moduleName + "--confirmed");
    } else {
      thisSubmitter.removeAttr('disabled');
      return thisMod.addClass(moduleName + "--confirmed");
    }
  });
};
...
lightbox = function() {
  var $, Swiper, createLayout, galLink, initGhostSlider, module, moduleName, removeLayout;
  moduleName = 'lightbox';
  $ = require('jquery');
  module = $("." + moduleName);
  if (module.length > 1) {
  ...
  createLayout = function() {
    ...
    layout = '<div class="ghost-gal"> <div class="ghost-gal__close"></div> <div class="ghost-gal__container swiper-container"> <div class="ghost-gal__wrapper swiper-wrapper"> </div> <div class="ghost-gal__slide-to ghost-gal__slide-to--prev"> <span class="ghost-gal__chev ghost-gal__chev--left"></span> </div> <div class="ghost-gal__slide-to ghost-gal__slide-to--next"> <span class="ghost-gal__chev ghost-gal__chev--right"></span> </div> </div> </div>';
    $('body').append(layout);
    allSlides = [];
  ...
  initGhostSlider = function(index) {
    var ghostSlider;
    ghostSlider = new Swiper('.ghost-gal__container', {
     
      navigation: {
        nextEl: '.ghost-gal__slide-to--next',
        prevEl: '.ghost-gal__slide-to--prev'
      }
    });
    return ghostSlider.slideTo(index);
  };
  ...
  return galLink.click(function(e) {
    var qThisLayout, thisClose, thisLayout, thisLink, thisLinkOrder;
    e.preventDefault();
    thisLink = $(this);
    thisLinkOrder = thisLink.index();
    createLayout();
...
},{"jquery":2,"swiper":5}],16:[function(require,module,exports){
var jform;
  ...
  return module.each(function() {
    ...
    return thisSubmitter.click(function(e) {
      ...
      if (isValid) {
       ...
       // modal = require('../modal/modal'); причина ошибки can't find module 19 
        ...
        XHR.done(function(msg) {
         ...
         /* module = $(".overlay--response");
  titleField = module.find("[data-res='title']");
  descField = module.find("[data-res='description']");
  titleField.html(title);
  descField.html(desc);
  module.addClass('overlay--enabled');
  if (modalAction === true) {
    return module.siblings('.overlay').removeClass('overlay--enabled');
  }*/
  
          //module=$('.popup__overlay');
...
$('.bg__popup').fadeOut();
        ...
        return XHR.fail(function(error) {
          ...
          //return modal('Возникла ошибка на сервере =(', 'Перезагрузите страницу', true);
        });
      }
    });
  });
...
},{"../modal/modal":19,"../preloader/preloader":21,"jquery":2}],17:[function(require,module,exports){
var logo;

logo = function() {
  var $, circle, colorize, layoutStates, module, moduleName, paths;
  moduleName = 'logo';
  $ = require('jquery');
  module = $("." + moduleName + ":not(." + moduleName + "--uncolorize)");
  if (module.length < 1) {
    return false;
  }
  layoutStates = require('../../blocks/layout/data/layout-states');
  paths = module.find('path');
  circle = module.find('circle');
  colorize = function(color, svgpart) {
    svgpart.css('fill', color);
    if (module.hasClass(moduleName + "--hidden")) {
      return module.removeClass(moduleName + "--hidden");
    }
  };
  module.click(function(e) {
    var item, neededLayoutClass, triggerStates;
    item = $(this);
    e.preventDefault();
    neededLayoutClass = item.data('trigger');
    triggerStates = require('../../blocks/triggers/data/trigger-states.js');
    return triggerStates.neededLayoutClass = neededLayoutClass;
  });
  return Object.observe(layoutStates, function(changes) {
    return $(changes).each(function() {
      var index;
      if (this.object.activeIndex !== void 0) {
        index = this.object.activeIndex;
        switch (index) {
          case 0:
            if ($(window).width() < 768) {
              colorize('rgb(15,15,15)', circle);
            } else {
              colorize('rgb(32,169,213)', circle);
            }
            return colorize('rgb(15,15,15)', paths);
          case 1:
            colorize('rgb(255,255,255)', paths);
            if ($(window).width() < 768) {
              return colorize('rgb(15,15,15)', circle);
            } else {
              return colorize('#d75832', circle);
            }
            break;
          case 2:
            if ($(window).width() < 768) {
              ...
              colorize('rgb(15,15,15)', paths);
              return colorize('#40a6d4', circle);
            }
            break;
          case 3:
            if ($(window).width() < 768) {
              ...
              colorize('#27b85a', circle);
            }
            return colorize('rgb(255,255,255)', paths);
          case 4:
            if ($(window).width() < 768) {
              colorize('rgb(15,15,15)', circle);
            } else {
              colorize('#8508f9', circle);
            }
            return colorize('rgb(255,255,255)', paths);
          case 5:
            if ($(window).width() < 768) {
              colorize('rgb(215,215,215)', circle);
            } else {
              colorize('#d75832', circle);
            }
            return colorize('rgb(255,255,255)', paths);
          case 6:
            if ($(window).width() > 768) {
              if (module.hasClass(moduleName + "--header")) {
                return module.addClass(moduleName + "--hidden");
              } else {
                return module.removeClass(moduleName + "--hidden");
              }
...
},{"../../blocks/layout/data/layout-states":8,"../../blocks/triggers/data/trigger-states.js":10,"jquery":2}],18:[function(require,module,exports){
var modal;
...
itemTriggers = function() {
  var $, items, module, moduleName, triggerStates;
  moduleName = 'j-overlay';
  $ = require('jquery');
  module = $("." + moduleName);
  if (module.length < 1) {
    return false;
  ...
  triggerStates = require('../../blocks/triggers/data/trigger-states.js');
  items = module.find("." + moduleName + "__item");
  return items.click(function() {
    var closeBtn, item, neededLayoutClass;
    item = $(this);
    neededLayoutClass = item.data('trigger');
    triggerStates.neededLayoutClass = neededLayoutClass;
    closeBtn = item.parents("." + moduleName).find("." + moduleName + "__close");
...
module.exports = itemTriggers;

},{"../../blocks/triggers/data/trigger-states.js":10,"jquery":2}],21:[function(require,module,exports){
var preloader;
...
preloader = function(action) {
  ...
  _removePreloader = function() {
    ...
    return preloader.fadeOut(500, function() {
      return $(this).remove();
    });
  };
  switch (action) {
...
var callmodule, checkbox, dataConfirm, forma, initMapbox, initTriggers, initXsScrollContent, itemTriggers, jform, layoutConstruct, lightbox, logo, preloader;

callmodule = require('./functions/callmodule');

layoutConstruct = require('../_modules/blocks/layout/layout');

forma = require('../_modules/blocks/forma/forma');

initTriggers = require('../_modules/blocks/triggers/triggers');

initMapbox = require('../_modules/components/map/map');

initXsScrollContent = require('../_modules/components/aside/aside');

itemTriggers = require('../_modules/components/overlay/overlay');

lightbox = require('../_modules/components/ghost-gal/ghost-gal');

jform = require('../_modules/components/jform/jform');

checkbox = require('../_modules/components/checkbox/checkbox');

dataConfirm = require('../_modules/components/confirm-data/confirm-data');

logo = require("../_modules/components/logo/logo");

preloader = require('../_modules/components/preloader/preloader');
...
},{"../_modules/blocks/forma/forma":7,"../_modules/blocks/layout/layout":9,"../_modules/blocks/triggers/triggers":11,"../_modules/components/aside/aside":12,"../_modules/components/checkbox/checkbox":13,"../_modules/components/confirm-data/confirm-data":14,"../_modules/components/ghost-gal/ghost-gal":15,"../_modules/components/jform/jform":16,"../_modules/components/logo/logo":17,"../_modules/components/map/map":18,"../_modules/components/overlay/overlay":20,"../_modules/components/preloader/preloader":21,"./functions/callmodule":22}]},{},[23])
